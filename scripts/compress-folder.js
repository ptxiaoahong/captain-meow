...
async function main() {
  ...
  if (args.length === 0) {
    console.log('使用方法: node compress-folder.js <文件夹名称>');
    console.log('示例: node compress-folder.js 17');
    console.log('说明: 压缩 static/<文件夹名称> 下的所有图片');
    process.exit(1);
  }
  ...
  console.log(`开始压缩文件夹: ${folderName}\n`);
